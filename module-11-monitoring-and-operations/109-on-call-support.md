...
[Home](../README.md) | [Course Modules](../README.md#course-modules) | [Previous](108-root-cause-analysis.md) | [Next](../module-12-production-support-scenarios/110-glue-job-failures.md)
...
* Explain what On Call Support means in an enterprise AWS environment
* Identify where On Call Support fits in data engineering, DevOps, security, or platform operations
* Describe common real-world use cases and operational risks
* Apply basic best practices in a production-style scenario
* Answer interview questions about On Call Support with clear examples
...
On Call Support is important because it affects:
...
On Call Support refers to the concepts, services, patterns, and operational practices used to support this part of an enterprise AWS platform.
...
In this environment, On Call Support must be designed carefully so teams can move quickly without creating security, reliability, or governance problems.

---

## Architecture Notes

When designing for On Call Support, consider:
...
### Lab: Explore On Call Support

Complete the following steps:

1. Review the AWS services or platform components related to On Call Support.
...
1. What is On Call Support?
2. Why is On Call Support important in an enterprise AWS environment?
3. Which teams are usually involved with On Call Support?
4. What are common production risks related to On Call Support?
5. How would you secure and monitor On Call Support?

---

## Student Assignment

Design an enterprise-ready approach for On Call Support.
...
On Call Support is part of the larger AWS DevOps and data engineering platform.
